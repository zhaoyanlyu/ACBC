...
plt.plot(x_axis, delay_ACBC, color='#E74C3C', linewidth=4.0, label='ACBC (ours)', zorder=0)
plt.plot(x_axis, delay_MAP, color='#884EA0', linewidth=2.0, label='MAP', zorder=0)
plt.plot(x_axis, delay_RICH, color='#2471A3', linewidth=2.0, label='RICH', zorder=0)
plt.plot(x_axis, delay_dsrb_0, color='#1ABC9C', linewidth=2.0, label='Distr-0', zorder=0)
plt.plot(x_axis, delay_dsrb_5, color='#9E9D24', linewidth=2.0, label='Distr-5', zorder=0)
plt.plot(x_axis, delay_dsrb_10, color='#F39C12', linewidth=2.0, label='Distr-10', zorder=0)
