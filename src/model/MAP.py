...
class MAP:
    def __init__(self, tau=0.8, tot_chunk=100, tot_EN=5, mu_xi=10., sigma_xi=1., EN_start=0):
        """
    ...
    def run_MAP(self):
        ...
        for kth_chunk in range(self.tot_chunk):
            ...
            for idx_EN in range(self.tot_EN - self.EN_start):
                if self.prob_of_k[kth_chunk] < self.tau:
...
if __name__ == '__main__':
    ...
    map = MAP(tau=tau, tot_chunk=tot_chunk, tot_EN=tot_EN, mu_xi=mu_xi, sigma_xi=sigma_xi, EN_start=EN_start)
